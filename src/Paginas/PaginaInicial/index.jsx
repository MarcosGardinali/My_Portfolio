      ...
      <main className={styles.conteudo}>
        <section className={styles.apresentacao}>
          ...
          <div className={styles.apresentacao__links}>
            ...
            <a href="https://github.com/MarcosGardinali" className={styles.apresentacao__botao}>
              <img src={github} alt="Logo do Github" />
                Github
            </a>
            <a href="https://linkedin.com/in/marcos-gardinali" className={styles.apresentacao__botao}>
              <img src={linkedin} alt="Logo do Linkedin" />
                LinkedIn
            </a>
            <a href="https://instagram.com/m_gardinali.21" className={styles.apresentacao__botao}>
